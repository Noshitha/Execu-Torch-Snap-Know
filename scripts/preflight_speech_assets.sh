...
check_file "$REPO_ROOT/app/src/main/assets/speech/stt/whisper-tiny/tokenizer.json"
check_file "$REPO_ROOT/app/src/main/assets/speech/stt/whisper-tiny/whisper_manifest.json"
